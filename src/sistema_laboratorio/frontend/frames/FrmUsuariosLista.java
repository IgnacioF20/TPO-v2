...
public class FrmUsuariosLista extends JDialog{
    ...
    public FrmUsuariosLista(String titulo){
        ...
        tablaUsuarios.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                FrmUsuarioVista frame = new FrmUsuarioVista("Crear Usuarios", dni);
        ...
        btnCrearUsuario.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                FrmUsuarioCrear frame = new FrmUsuarioCrear("Crear Usuarios");
                frame.setVisible(true);
            }
        });
        tablaUsuarios.addComponentListener(new ComponentAdapter() {
        });
    }
}